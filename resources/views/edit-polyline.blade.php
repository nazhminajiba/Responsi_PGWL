            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                     <form action="{{ route('update-polyline', $id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        (this.files[0]) ">
                        <input type="hidden" class="fore-control" id="image_old" name="image_old">
                        </div>
                        <div class="mb-3">
    ...
    <script>
        ...
        map.on('draw:edited', function(e) {
            ...
            layer.eachLayer(function(layer) {
                ...
                $('#preview-image-polyline').attr('src', '{{ asset('storage/images/') }}/' + layer.
 ...
 var polyline = L.geoJson(null, {
            onEachFeature: function(feature, layer) {
                ...
                var popupContent = "Nama: " + feature.properties.name + "<br>" +
                    ...
                    "Foto:<br><img src='{{ asset('storage/images/') }}/" + feature.properties.image + "'class='' alt='...'width='200'>"
                    + "<br>"  ;
