        ...
        <div class="container-fluid">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li><a class="dropdown-item" href="{{ route('table-polygon') }}">Polygon</a></li>
                    ...
                    @if (Auth::check())
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('dashboard') }}"><i class="fa-solid fa-circle-up"></i></i>Dashboard</a>
                    </li>
                    <form method="POST" action="{{ route('logout') }}">
                            @csrf
                    <li class="nav-item">
                        <button class="nav-link text-danger" type="submit"><i class="fa-solid fa-right-to-bracket"></i>Logout</a>
                    </li>
                    </form>
                    @else
                    <li class="nav-item">
...
<div class="modal fade" id="infoModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <img src="storage/images/gambar.png" alt="Profile Image" class="img-fluid rounded-circle" width="200">
</div>
